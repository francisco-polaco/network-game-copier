...
## Current State
It has a cute but horrible GUI that allows users to list the Steam and Blizzard games from a computer selected and download them using FTP. It's expected to implement some sort of requests' queue.
### Security
